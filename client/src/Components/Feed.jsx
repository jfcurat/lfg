...
class Feed extends Component {
  formatPostsArray() {
    ...
    const sortedPosts = posts
      .sort((postA, postB) => {
        return moment(postB.timeCreated).diff(moment(postA.timeCreated));
      })
      .map(post => {
        return {
          ...post,
  ...
  render() {
    ...
    return (
      <div className="container" style={{ marginTop: 15, marginBottom: 15 }}>
        <button className='btn btn-outline-light gamesButton' onClick={this.props.refresh}>Refresh feed</button>
        <div
                  ...
                  >
                    <div className="row">
                      ...
                      <div className="col-sm-3 col-md-2">
                        <p>
                          <span>
                            Players needed: {post.amountOfPlayersNeeded}
                          </span>
                        </p>
                      </div>
                    </div>
